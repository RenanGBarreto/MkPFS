"""Parity tests for constants between legacy ffpfs.py and mkpfs.consts.

Verifies that all constants from the legacy implementation match the current
mkpfs.consts module, ensuring no regressions in PFS format handling.
"""

import mkpfs.consts as consts


class TestPFSMagicAndVersion:
